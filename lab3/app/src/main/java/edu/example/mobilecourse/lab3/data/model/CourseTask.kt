package edu.example.mobilecourse.lab3.data.model

/**
 * 课程任务数据类(实验三沿用实验二的数据模型,字段不变)。
 *
 * 实验三关键变化:数据访问从"顶层常量直接被 UI 读"改为"由 [edu.example.mobilecourse.lab3.data.repository.TaskRepository]
 ...
 *
 * 实验三:这份数据由 [edu.example.mobilecourse.lab3.data.repository.FakeTaskRepository]
 ...
 * 由 [edu.example.mobilecourse.lab3.data.repository.FakeTaskRepository] 在 emptyMode 开启时返回。
 */
